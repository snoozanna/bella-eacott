      ...
      <section className="expect content skinny">
        ...
        <div className="content-item">
          <p>
            ...
            preferences, symptoms and medical history.
          </p>
          ...
          <ul>
            ...
            <li>
              • Deep tissue massage, which tends to also be full body but using
              slightly stronger pressure
            </li>
            <li>
            ...
            <li>
              ...
              concern / injuries and often uses more active approaches, longer
              consultation at the start and time for rehabilitation advice and
        ...
        <div className="content-item">
          <p>
            ...
            stretching and take-home or exercise advice as needed; the pressure
            I use will be guided by dialogue between us. My approach draws on
            the understanding of anatomy and physiology, pathology, biomechanics
            and rehabilitation that underpin my training in osteopathy.
          </p>

          <p>
            My practice aims to be actively consent led, body neutral /
            positive, gender and sexuality affirmative and anti-racist; I try to
            be aware of the influence of my own embodied experiences - as a
            ...
            ask questions where appropriate so that I don’t make assumptions. If
            I think you may benefit from treatment from someone else (another
            kind of practitioner, such as an acupuncturist, for instance) I will
            always recommend them to you too.
          </p>
        </div>
      </section>
    </>
